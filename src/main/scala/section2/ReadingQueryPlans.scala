...
object ReadingQueryPlans extends App {
  ...
  *(5) Project [id#195L]
  ...
  /*
  (1) MapPartitionsRDD[3] at join at ReadingQueryPlans.scala:129 []
   |  MapPartitionsRDD[2] at join at ReadingQueryPlans.scala:129 []
   |  CoGroupedRDD[1] at join at ReadingQueryPlans.scala:129 []
   +-(1) ParallelCollectionRDD[0] at parallelize at ReadingQueryPlans.scala:128 []
   +-(1) ParallelCollectionRDD[0] at parallelize at ReadingQueryPlans.scala:128 []
  */
